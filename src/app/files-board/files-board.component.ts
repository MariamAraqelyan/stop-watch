...
@Component({
  selector: 'app-files-board',
  templateUrl: './files-board.component.html',
  styleUrls: ['./files-board.component.scss']
})
export class FilesBoardComponent implements OnInit, AfterViewInit {
